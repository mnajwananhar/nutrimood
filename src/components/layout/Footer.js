      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-1">
            ...
            <p className="mt-4 text-sm text-gray-500 dark:text-gray-400 max-w-md">
              Aplikasi inovatif yang menghubungkan kondisi psikologis dan
              kesehatan fisik melalui rekomendasi makanan yang dipersonalisasi.
              Berdasarkan penelitian terbaru dalam bidang psikonutrisi.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li className="flex items-start">
                ...
                <span className="text-base text-gray-500 dark:text-gray-400">
                  Jl. Dipatiukur No. 112-116, Bandung, Jawa Barat, Indonesia
                </span>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700">
          <p className="text-base text-gray-400 text-center">
            &copy; {currentYear} NutriMood. Hak Cipta Dilindungi.
          </p>
        </div>
      </div>
    </footer>
