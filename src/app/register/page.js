...
export default function Register() {
  ...
  const validatePassword = (password) => {
    // Validate password to have at least 8 characters, one uppercase, one lowercase, and one number
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      if (!validatePassword(password)) {
        throw new Error(
          "Password harus terdiri dari minimal 8 karakter, satu huruf besar, satu huruf kecil, dan satu angka"
        );
      }
      ...
      // In a production app, we'd redirect to a verification page
        ...
        {success ? (
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-green-700 dark:text-green-400">
                  <p>
                    Silakan periksa email Anda untuk tautan verifikasi. Setelah
                    verifikasi selesai, Anda dapat login ke akun Anda.
                  </p>
                </div>
                <div className="mt-4">
                  <div className="-mx-2 -my-1.5 flex">
                    <Link
                      href="/login"
                      className="bg-green-50 dark:bg-green-900/30 px-2 py-1.5 rounded-md text-sm font-medium text-green-800 dark:text-green-300 hover:bg-green-100 dark:hover:bg-green-900/50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
                    >
          ...
          <form className="mt-8 space-y-6" onSubmit={handleRegister}>
            <div className="rounded-md shadow-sm -space-y-px">
              ...
              <div>
                ...
                <input
                  ...
                  className="appearance-none relative block w-full px-3 py-2 border border-gray-300 dark:border-neutral-600 placeholder-gray-500 dark:placeholder-gray-400 text-gray-900 dark:text-white dark:bg-neutral-800 focus:outline-none focus:ring-primary-500 focus:border-primary-500 focus:z-10 sm:text-sm"
            ...
            <div className="text-sm text-gray-600 dark:text-gray-400">
              <p>
                Password harus terdiri dari minimal 8 karakter, satu huruf
                besar, satu huruf kecil, dan satu angka.
              </p>
            </div>
