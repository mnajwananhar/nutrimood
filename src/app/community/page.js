    ...
    const fetchPosts = async () => {
        try {
            ...
            const transformedPosts = data.map(post => ({
                ...
                user_liked: post.likes?.some(like => like.user_id === user?.id) || false
            }));
        ...
        <div className="min-h-screen bg-gray-50 dark:bg-neutral-900 py-12">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="space-y-6">
                    {posts.map((post) => (
                        <div key={post.id} className="bg-white dark:bg-neutral-800 rounded-lg shadow-lg p-6">
                            <div className="flex items-center justify-between mb-4">
                                ...
                                {user && post.user_id === user.id && (
                                    <div className="flex space-x-2">
                                        <button
                                            onClick={() => handleUpdate(post.id, { title: post.title, content: post.content })}
                            ...
                            <div className="flex items-center space-x-4">
                                <button
                                    ...
                                    className={`flex items-center space-x-1 ${post.user_liked
