...
export default function Profile() {
  ...
  const fetchUserData = async () => {
    try {
      ...
      if (error) {
        // Jika error karena tidak ada row, insert profile baru
        if (
          error.code === "PGRST116" ||
          ...
          // Jika error lain, tampilkan alert
          const errorMsg =
            error.message || error.details || JSON.stringify(error);
          alert("Terjadi kesalahan saat mengambil data profile: " + errorMsg);
        }
      } else {
        setProfile(profile);
        setFormData({
  ...
  const handleImageUpload = async (e) => {
    try {
      ...
      if (uploadError) {
        alert(uploadError.message || "Gagal mengunggah gambar.");
        return;
      }
      ...
      if (updateError) {
        alert(updateError.message || "Gagal memperbarui profil dengan avatar.");
        return;
      }
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="very_active">
                      Very Active (Olahraga Sangat Berat)
                    </option>
                  </select>
                </div>
                ...
                <div className="sm:col-span-2">
                  ...
                  >
                    ...
                    <option value="lactose_intolerant">
                      Intoleransi Laktosa
                    </option>
